...
function OnlinePackage() {
  return (
    <div className="space-y-7 flex flex-wrap pb-20">
      <div className="text-white font-semibold text-5xl w-full text-center mb-10  ">
        <span className="border-b-2 border-b-[#eb8900]">
          ONLINE PAKETLER
        </span>{" "}
      </div>
      <div className="border  border-gray-500 w-full  px-16 justify-center items-center p-4">
      ...
      <div className="border border-gray-500 w-full px-16 justify-center items-center p-4">
        <div className="flex items-center justify-center space-x-7">
          <div>
            <img src={food} className="h-10 md:h-20" />
          </div>
          <p className="uppercase text-white text-sm md:text-base font-semibold">
      ...
      <div className="border border-gray-500 w-full  md:px-16 justify-center items-center p-4">
        <div className="flex items-center justify-center space-x-7">
          <div>
      ...
      <div className="w-full text-center space-x-7">
