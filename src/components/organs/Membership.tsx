...
const Membership = () => {
  return (
    <section className="w-full  h-auto py-20 pt-32 lg:pt-40 bg-zinc-950 flex flex-col md:gap-28 gap-20 justify-center items-center">
      ...
      <main className="grid lg:w-[90%] md:w-[96%] w-[90%] md:grid-cols-4 items-center gap-8 md:gap-4 lg:gap-8">
        {MembershipPlans.cards.map((card, index) => (
          <Card
            className={`w-full flex flex-col items-center gap-4 border border-zinc-500  transition-all duration-200 cursor-pointer hover:border-red-500/50 ${
              index === 1 ? "lg:py-16 py-10" : "lg:py-16 py-10"
            }`}
            key={index}
          >
            <Text as="h2" className="text-zinc-100 flex items-end gap-0.5">
              <span className="font-extrabold text-2xl">TL</span>
              <span
            ...
            <a
              href="https://wa.me/905366071938?text=Merhaba,%20paket%20satın%20almak%20istiyorum."
              target="_blank"
            >
