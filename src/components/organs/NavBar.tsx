...
const NavBar = () => {
  ...
  return (
    <header className="w-full h-auto bg-transparent overflow-x-hidden fixed z-50 top-0 left-0 overflow-hidden">
      <nav
      ...
      >
        ...
        >
          <Text
            as="span"
            className="text-amber-500 absolute -top-6 md:left-6 left-3"
          >
            <Barbell size={30} color="currentColor" weight="fill" />
          </Text>
          <Text as="span" className="text-white text-2xl md:text-4xl mr-2">
            UGUR
          </Text>
          <Text
            as="span"
            className="text-2xl md:text-4xl bg-gradient-to-r from-amber-500 to-red-500 bg-clip-text text-transparent"
          >
            ÇOLAK
          </Text>
        </Link>
      ...
      {/* Mobile Nav  */}
      <nav
        className={`flex justify-end overflow-hidden lg:hidden h-screen w-full bg-gray-950/90 fixed top-0  ${
          ...
          <section className="w-full px-4 py-6 flex flex-col gap-16">
            <div className="w-full flex pt-5 px-4 justify-between items-center">
              ...
              >
                <Text
                  as="span"
                  className="text-amber-500 absolute -top-4 md:left-4 left-[14px]"
                >
                  <Barbell size={25} color="currentColor" weight="fill" />
                </Text>
                <Text as="span" className="text-white text-2xl mr-2">
                  UGUR
                </Text>
                <Text
                  as="span"
                  className="text-2xl bg-gradient-to-r from-amber-500 to-red-500 bg-clip-text text-transparent"
                >
                  ÇOLAK
                </Text>
              </Link>
